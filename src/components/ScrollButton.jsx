...
function ScrollButton() {
  ...
  return (
    <div className='flex justify-center space-x-16 cursor-pointer'>
      <button
        onClick={goBack}
        className={`absolute bottom-[18%] lg:bottom-[23%] xl:bottom-[22%] w-4 h-4 bg-primary-white border border-brand-green border-opacity-40 rounded-full shadow-shape transition-all duration-300 hover:bg-primary-color hover:border-brand-red hover:border-opacity-40'
