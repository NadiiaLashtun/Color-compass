...
function ResultsSection({ colors, prompt }) {
  return (
    <section className='bg-result-page bg-contain bg-left-top bg-repeat-y lg:bg-cover bg-primary-color w-full lg:h-[calc(100vh-60px)] border-y border-secondary-color content-center animate-slideIn'>
